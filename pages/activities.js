...
const activities = () => {
  return (
    <div>
      ...
      V.I.	Harvest Plus Task-Oriented Training (TOT) Program: - Harvest Plus hosted two-day Task-Oriented Training (TOT) program from 1st April 2019 to 2nd April 2019 at Patna which was attended by Dr Abhay Shanker Tiwari, Secretary (BLVESS).
      ...
      V.3.	Stakeholder Meeting for Establishing Sustainable Systems for Development and Deployment of Biofortified Crops (Zinc Wheat): - The main agenda of the meeting was to provide an opportunity to share the learning from last year and to develop effective seed production, marketing, distribution and food processing models for implementation in Uttar Pradesh.
      ...
      V.4.	Policy Sharing Workshop by DMI and Harvest Plus: - Development Management Institute (DMI), Patna, Harvest Plus, and International Food Policy Research Institute (IFPRI), South Asia Office, New Delhi, organized a half-day policy sharing workshop on 23rd September 2019 in Patna Bihar. They conducted a field-based study to develop a policy paper on increasing the production and availability of Biofortified Rice and Wheat in the state of Bihar and Odisha.
